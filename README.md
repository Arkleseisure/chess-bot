...
Exe file is too big (just) to upload to GitHub due to the opening book, but the latest one can be downloaded here:
https://1drv.ms/u/s!AgqdwyIi0M_0lXaEe1ESpXRajnxH?e=RDlTGo
